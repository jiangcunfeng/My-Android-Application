...
//        textView = findViewById(R.id.textView);
    ...
    private void initBtns() {
        img_refresh = findViewById(R.id.img_refresh_mine);
...
//            ImageHelper.displayWebImage(video.getImageUrl(), img);
            ...
            img_heart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(!isLove){
                        Toast.makeText(MineActivity.this,"添加到喜欢", Toast.LENGTH_SHORT).show();
                        Animation loadAnimation = AnimationUtils.loadAnimation(MineActivity.this,R.anim.heart_holder);
                        ...
                        Toast.makeText(MineActivity.this,"已取消喜欢", Toast.LENGTH_SHORT).show();
    ...
    private void initRecyclerView() {
        mRv = findViewById(R.id.recycler_mine);
//        mRv.setLayoutManager(new ViewPagerLayoutManager(this, OrientationHelper.VERTICAL));
        mLayoutManager = new ViewPagerLayoutManager(this, OrientationHelper.VERTICAL);
        mRv.setLayoutManager(mLayoutManager);
        mRv.setAdapter(new RecyclerView.Adapter<MineActivity.MyViewHolder>() {
            @NonNull
            @Override
            public MineActivity.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                return new MineActivity.MyViewHolder(
                        LayoutInflater.from(MineActivity.this)
                                .inflate(R.layout.item_view_pager, viewGroup, false));
            }

            @Override
            public void onBindViewHolder(@NonNull MineActivity.MyViewHolder viewHolder, int i) {
                final Video video = mVideos.get(i);
                viewHolder.bind(MineActivity.this, video);
            }
...
//                    mVideos = response.body().getVideos();
                    Toast.makeText(MineActivity.this,"refresh",Toast.LENGTH_SHORT);

                    mVideos = response.body().getOnesVideos("hhh");

                    if(mVideos==null){
                        Toast.makeText(MineActivity.this,"find no video",Toast.LENGTH_LONG);
                    }
            ...
            public void onFailure(Call<GetVideosResponse> call, Throwable throwable) {
                ...
                Toast.makeText(MineActivity.this, s, Toast.LENGTH_LONG).show();
            }
        });
