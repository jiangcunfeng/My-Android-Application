...
import com.bytedance.androidcamp.network.dou.hotMsg.HotMessage;
import com.bytedance.androidcamp.network.dou.hotMsg.HotMessageAdapter;

import java.util.ArrayList;
import java.util.List;

public class HotMsgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hot_msg);
